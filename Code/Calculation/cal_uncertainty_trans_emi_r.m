% calculate uncertainty of transportation/emission ratio to emissions
clear all
...
for i = 1:length(ratios)
    ...
    save([path, 'uncertainty_trans_r_', num2str(ratio), '_', num2str(yr_sta) '-', num2str(yr_end), '.mat'], 'un')
    E_yr(E_yr == 0) = NaN;
