% mean spatial distribution of CH4 emission difference from prior and posterior livestock sources
clear all
...
caxis([-max max]);
cmp = importdata(['D:\data\colormap\seismic.txt']);
colormap(cmp(:,1:3));
...
space(1 : 150) = 32; 
title(strcat('Post - Prior (10^{-11} kg/m^{2}/s)', space(1:sp), 'Livestock'), 'FontSize' , 15 , 'FontName' ,'Times New Roman'); 
axis normal;
f = gcf;
exportgraphics(f,['C:\Users\Administrator\Desktop\output\CH4_diff_livestock.png'],'Resolution',300)
