% mean spatial distribution of NO2 burden from GEOS-Chem
clear
...
for yr = yr_sta:yr_end
    ...
    for m = 1:12
        ...
        month = num2str(m,'%02d');
        datayrm = ncread([path, 'OutputDir', num2str(year), '\GEOSChem.SpeciesConc.', year, month, '01_0000z.nc4'], 'SpeciesConc_NO2');
...
save([path, 'chem_no2_', num2str(yr_sta), '-', num2str(yr_end), '.mat'], 'data');
...
% f = gcf;
% exportgraphics(f,['C:\Users\Administrator\Desktop\Pap\figure\figS4.png'],'Resolution',300)
